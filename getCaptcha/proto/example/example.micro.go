...
type ExampleService interface {
	GetCaptcha(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *exampleService) GetCaptcha(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
type ExampleHandler interface {
	GetCaptcha(context.Context, *Request, *Response) error
}

func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		GetCaptcha(ctx context.Context, in *Request, out *Response) error
	}
	type Example struct {
		example
	}
...
func (h *exampleHandler) GetCaptcha(ctx context.Context, in *Request, out *Response) error {
